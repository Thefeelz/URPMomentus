...
public class PlayerAttack : MonoBehaviour
{
    ...
    public void CheckForDamage()
    {
        ...
        Physics.Raycast(pos, Camera.main.transform.forward, out hit, 2.5f);
        Physics.Raycast(pos1, Camera.main.transform.forward, out hit1, 2.5f);
        Physics.Raycast(pos2, Camera.main.transform.forward, out hit2, 2.5f);
