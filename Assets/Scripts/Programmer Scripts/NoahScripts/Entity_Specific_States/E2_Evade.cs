...
public class E2_Evade : EvadeState
{

    float x;
    Enemy2 mEnemy;
    public bool jumpStarted;
    public E2_Evade(Entity mEntity, FiniteStateMachine mStateMachine, D_Evade evadeData, D_Entity entityData, Enemy2 mEnemy) : base(mEntity, mStateMachine, evadeData, entityData)
    {
